...
module.exports = {
  async index(req, res){
    ...
    async create(req, res) {
      const {nome_usuario, email_usuario, tipo_usuario, senha_usuario, nome_empresa, Cnpj, Endereco, Telefone, Uf} = req.body;
      let data = {};
//verificar se o email já tem cadastro
      let user = await Usuario.findOne({email_usuario});
      
      if(!user) {
        data = {nome_usuario, email_usuario, tipo_usuario, senha_usuario, nome_empresa, Cnpj, Endereco, Telefone, Uf};
    ...
    async details(req, res){
      ...
      async delete(req, res){
        ...
        const {_id, nome_usuario, email_usuario, tipo_usuario, senha_usuario, nome_empresa, Cnpj, Endereco, Telefone, Uf} = req.body;     
        const data = {nome_usuario, email_usuario, tipo_usuario, senha_usuario, nome_empresa, Cnpj, Endereco, Telefone, Uf};
